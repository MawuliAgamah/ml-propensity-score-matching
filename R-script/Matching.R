...
# 3 - nsw treated + cps controol  (dehejia & wahba subsample)
# 4 - nsw treated +  psid control (dehejia & wahba subsample)
...
# un-adjusted CART data set's taken from python
...
CS_plot_logit1 <- bal.plot(m_out_cart1, var.name = "propensity_score", which = "both",type = "histogram", mirror = TRUE)
...
# load unmatched forest data set's
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
# Check common support for each model
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
ggarrange(cs_logit_plt1,cs_logit_plt2,
          ...
          nrow = 4 , ncol = 2,
          common.legend = TRUE, 
          labels = c("Logit","","CART","","XG-BOOST","","Forest"),
