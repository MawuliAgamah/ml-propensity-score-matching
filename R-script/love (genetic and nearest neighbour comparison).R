...
# nearest neighbor 
m_out_logit_nn1 <- matchit(formula = forumla1, data = logitUndajusted1, method = "nearest",ratio=1,distance = logitUndajusted1$propensity_logit,caliper = caliper1,replace =  TRUE)
m_out_logit_nn2 <- matchit(formula = forumla1, data = logitUndajusted2, method = "nearest",ratio=1, distance = logitUndajusted2$propensity_logit,caliper = caliper2, replace =  TRUE)
m_out_logit_nn3 <- matchit(formula = forumla2, data = logitUndajusted3, method = "nearest",ratio=1, distance = logitUndajusted3$propensity_logit,caliper = caliper3,replace =  TRUE)
m_out_logit_nn4 <- matchit(formula = forumla2, data = logitUndajusted4, method = "nearest",ratio=1, distance = logitUndajusted4$propensity_logit,caliper = caliper4, replace =  TRUE)

# genetic matching 
m_out_logit_gen1 <- matchit(formula = forumla1, data = logitUndajusted1,method = "genetic",distance = logitUndajusted1$propensity_logit,caliper = caliper1,replace =  TRUE,pop.size = 50)
m_out_logit_gen2 <- matchit(formula = forumla1, data = logitUndajusted2, method = "genetic", distance = logitUndajusted2$propensity_logit,caliper = caliper2, replace =  TRUE,pop.size = 50)
m_out_logit_gen3 <- matchit(formula = forumla2, data = logitUndajusted3, method = "genetic", distance = logitUndajusted3$propensity_logit,caliper = caliper3,replace =  TRUE,pop.size = 50)
m_out_logit_gen4 <- matchit(formula = forumla2, data = logitUndajusted4, method = "genetic", distance = logitUndajusted4$propensity_logit,caliper = caliper4, replace =  TRUE,pop.size = 50)# 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~# 
# CART
...
# nearest neighbor 
m_out_cart_nn1 <- matchit(formula = forumla1, data = cartUndajusted1, method = "nearest",ratio=1,distance = cartUndajusted1$propensity_logit,caliper = caliper1,replace =  TRUE)
m_out_cart_nn2 <- matchit(formula = forumla1, data = cartUndajusted2, method = "nearest",ratio=1, distance = cartUndajusted2$propensity_logit,caliper = caliper2,replace =  TRUE)
m_out_cart_nn3 <- matchit(formula = forumla2, data = cartUndajusted3, method = "nearest",ratio=1, distance = cartUndajusted3$propensity_logit,caliper = caliper3,replace =  TRUE)
m_out_cart_nn4 <- matchit(formula = forumla2, data = cartUndajusted4, method = "nearest",ratio=1, distance = cartUndajusted4$propensity_logit,caliper = caliper4,replace =  TRUE)

# genetic matching
m_out_cart_gen1 <- matchit(formula = forumla1, data = cartUndajusted1, method = "genetic",distance = cartUndajusted1$propensity_logit,caliper = caliper1,replace =  TRUE,pop.size = 50)
m_out_cart_gen2 <- matchit(formula = forumla1, data = cartUndajusted2, method = "genetic", distance = cartUndajusted2$propensity_logit,caliper = caliper2,replace =  TRUE,pop.size = 50)
m_out_cart_gen3 <- matchit(formula = forumla2, data = cartUndajusted3, method = "genetic", distance = cartUndajusted3$propensity_logit,caliper = caliper3,replace =  TRUE,pop.size = 50)
m_out_cart_gen4 <- matchit(formula = forumla2, data = cartUndajusted4, method = "genetic", distance = cartUndajusted4$propensity_logit,caliper = caliper4,replace =  TRUE,pop.size = 50)
...
# nearest neighbor 
m_out_forest_nn1 <- matchit(formula = forumla1, data = forestUndajusted1, method = "nearest",ratio=1,distance = forestUndajusted1$propensity_logit,caliper = caliper1,replace =  TRUE)
m_out_forest_nn2 <- matchit(formula = forumla1, data = forestUndajusted2, method = "nearest",ratio=1, distance = forestUndajusted2$propensity_logit,caliper =caliper2,replace =  TRUE)
m_out_forest_nn3 <- matchit(formula = forumla2, data = forestUndajusted3, method = "nearest",ratio=1, distance = forestUndajusted3$propensity_logit,caliper = caliper3,replace =  TRUE)
m_out_forest_nn4 <- matchit(formula = forumla2, data = forestUndajusted4, method = "nearest",ratio=1, distance = forestUndajusted4$propensity_logit,caliper = caliper4,replace =  TRUE)

# genetic matching 
m_out_forest_gen1 <- matchit(formula = forumla1, data = forestUndajusted1, method = "genetic",distance = forestUndajusted1$propensity_logit,caliper = caliper1,replace =  TRUE,pop.size = 50)
m_out_forest_gen2 <- matchit(formula = forumla1, data = forestUndajusted2, method = "genetic", distance = forestUndajusted2$propensity_logit,caliper =caliper2,replace =  TRUE,pop.size = 50)
m_out_forest_gen3 <- matchit(formula = forumla2, data = forestUndajusted3, method = "genetic", distance = forestUndajusted3$propensity_logit,caliper = caliper3,replace =  TRUE,pop.size = 50)
m_out_forest_gen4 <- matchit(formula = forumla2, data = forestUndajusted4, method = "genetic", distance = forestUndajusted4$propensity_logit,caliper = caliper4,replace =  TRUE,pop.size = 50)
...
m_out_boost_nn1 <- matchit(formula = forumla1, data = boostUndajusted1, method = "nearest",ratio=1, distance = boostUndajusted1$propensity_logit,caliper =caliper1,replace =  TRUE)
m_out_boost_nn2 <- matchit(formula = forumla1, data = boostUndajusted2, method = "nearest",ratio=1, distance = boostUndajusted2$propensity_logit,caliper = caliper2,replace =  TRUE)
m_out_boost_nn3 <- matchit(formula = forumla2, data = boostUndajusted3, method = "nearest",ratio=1, distance = boostUndajusted3$propensity_logit,caliper = caliper3,replace =  TRUE)
m_out_boost_nn4 <- matchit(formula = forumla2, data = boostUndajusted4, method = "nearest",ratio=1, distance = boostUndajusted4$propensity_logit,caliper = caliper4,replace =  TRUE)
#genetic matching 
m_out_boost_gen1 <- matchit(formula = forumla1, data = boostUndajusted1, method = "genetic", distance = boostUndajusted1$propensity_logit,caliper =caliper1,replace =  TRUE,pop.size = 50)
m_out_boost_gen2 <- matchit(formula = forumla1, data = boostUndajusted2, method = "genetic", distance = boostUndajusted2$propensity_logit,caliper = caliper2,replace =  TRUE,pop.size = 50)
m_out_boost_gen3 <- matchit(formula = forumla2, data = boostUndajusted3, method = "genetic", distance = boostUndajusted3$propensity_logit,caliper = caliper3,replace =  TRUE,pop.size = 50)
m_out_boost_gen4 <- matchit(formula = forumla2, data = boostUndajusted4, method = "genetic", distance = boostUndajusted4$propensity_logit,caliper = caliper4,replace =  TRUE,pop.size = 50)
...
#nearest neighbor
m_out_ann_nn1 <- matchit(formula = forumla1, data = annUndajusted1, method = "nearest",ratio=1, distance = annUndajusted1$propensity_logit,caliper = caliper1,replace =  TRUE)
m_out_ann_nn2 <- matchit(formula = forumla1, data = annUndajusted2, method = "nearest",ratio=1, distance = annUndajusted2$propensity_logit,caliper = caliper2,replace =  TRUE)
m_out_ann_nn3 <- matchit(formula = forumla2, data = annUndajusted3, method = "nearest",ratio=1, distance = annUndajusted3$propensity_logit,caliper = caliper3,replace =  TRUE)
m_out_ann_nn4 <- matchit(formula = forumla2, data = annUndajusted4, method = "nearest",ratio=1, distance = annUndajusted4$propensity_logit,caliper = caliper4,replace =  TRUE)
#genetic matching 
m_out_ann_gen1 <- matchit(formula = forumla1, data = annUndajusted1, method = "genetic", distance = annUndajusted1$propensity_logit,caliper = caliper1,replace =  TRUE,pop.size = 50)
m_out_ann_gen2 <- matchit(formula = forumla1, data = annUndajusted2, method = "genetic", distance = annUndajusted2$propensity_logit,caliper = caliper2,replace =  TRUE,pop.size = 50)
m_out_ann_gen3 <- matchit(formula = forumla2, data = annUndajusted3, method = "genetic", distance = annUndajusted3$propensity_logit,caliper = caliper3,replace =  TRUE,pop.size = 50)
m_out_ann_gen4 <- matchit(formula = forumla2, data = annUndajusted4, method = "genetic", distance = annUndajusted4$propensity_logit,caliper = caliper4,replace =  TRUE,pop.size = 50)
