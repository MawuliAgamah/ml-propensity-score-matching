...
logit_lalonde
ggsave('/Users/mawuliagamah/gitprojects/causal_inference/causal_inference/Plots/Balance plots/LOGIT_FS.png', plot = last_plot(),
...
cart_lalonde <-ggarrange(balance_plot_cart1,balance_plot_cart2, 
                          ...
                          ncol = 4,nrow = 1, common.legend = TRUE, legend="right")
cart_lalonde
ggsave('/Users/mawuliagamah/gitprojects/causal_inference/causal_inference/Plots/Balance plots/cart_FS.png', plot = last_plot(),
       width = 22, height = 8 , device = "png", dpi=700)
...
boost_lalonde <-ggarrange(balance_plot_boost1,balance_plot_boost2, 
                         ...
                         ncol = 4,nrow = 1, common.legend = TRUE, legend="right")
boost_lalonde
ggsave('/Users/mawuliagamah/gitprojects/causal_inference/causal_inference/Plots/Balance plots/boost_fs.png', plot = last_plot(),
       width = 22, height = 8 , device = "png", dpi=700)
...
forest_lalonde <-ggarrange(balance_plot_forest1,balance_plot_forest2, 
                          ...
                          ncol = 4,nrow = 1, common.legend = TRUE, legend="right")
forest_lalonde
ggsave('/Users/mawuliagamah/gitprojects/causal_inference/causal_inference/Plots/Balance plots/forest_fs.png', plot = last_plot(),
       width = 22, height = 8 , device = "png", dpi=700)
...
ann_lalonde <-ggarrange(balance_plot_ann1,balance_plot_ann2, 
                           ...
                           ncol = 4,nrow = 1, common.legend = TRUE, legend="right")
ann_lalonde
ggsave('/Users/mawuliagamah/gitprojects/causal_inference/causal_inference/Plots/Balance plots/ann_fs.png', plot = last_plot(),
       width = 22, height = 8 , device = "png", dpi=700)
